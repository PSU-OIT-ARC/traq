...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tickets_tickettype', (
            ('ticket_type_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'tickets', ['TicketType'])

        # Adding field 'Ticket.type'
        db.add_column('ticket', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tickets.TicketType'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('ticket', 'type_id')
    ...
    models = {
        ...
        u'tickets.ticket': {
            ...
            'started_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 18, 0, 0)'}),
