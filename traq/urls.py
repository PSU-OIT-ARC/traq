...
urlpatterns = patterns('',
    ...
    url(r'^accounts/profile/timesheet/$', accounts.views.timesheet, name='accounts-timesheet'),
    ...
    url(r'^milestones/(\d+)/detail/?$', projects.views.milestones.detail, name='milestones-detail'),
